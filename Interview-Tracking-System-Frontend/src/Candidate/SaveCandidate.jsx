          ...
          <form onSubmit={handleSubmit(saveCandidate)}>
            ...
            {errors.candidateName &&
              errors.candidateName.type === "required" && (
                <span className="error"> Candidate Name is Required</span>
              )}
            {errors.candidateName &&
              errors.candidateName.type === "maxLength" && (
                <span className="error">
                  Candidate Name must not contain more than 20 charcters
                </span>
              )}
              <br />
            ...
            {errors.primarySkills &&
              errors.primarySkills.type === "required" && (
                <span className="error">Primary Skills are Required</span>
              )}
            {errors.primarySkills &&
              errors.primarySkills.type === "maxLength" && (
                <span className="error">
                  Primary Skills must not contain more than 10 charcters
                </span>
              )}
              <br />
            ...
            {errors.secondarySkills &&
              errors.secondarySkills.type === "required" && (
                <span className="error">Secondary Skills are Required</span>
              )}
            {errors.secondarySkills &&
              errors.secondarySkills.type === "maxLength" && (
                <span className="error">
                  Secondary Skills must not contain more than 10 charcters
                </span>
              )}
              <br />
           ...
           <br />
            ...
            {errors.qualification &&
              errors.qualification.type === "maxLength" && (
                <span className="error">
                  Qualification must not contain more than 10 charcters
                </span>
              )}
              <br />
            ...
            {errors.designation && errors.designation.type === "maxLength" && (
              <span className="error">
                Designation must not contain more than 10 charcters
              </span>
            )}
            <br />
            ...
            {errors.noticePeriod && errors.noticePeriod.type === "required" && (
              <span className="error">Notice Period is Required</span>
            )}
            <br />
            <input
              type="text"
