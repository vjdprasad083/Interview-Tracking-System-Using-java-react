    ...
    return (
       ...
       <div className="addCandidate">
            <div className="addCandidate-form">
               ...
               <input type="text" name="adminId" placeholder="Id" className="form-control"
                {...register("adminId", {required:true})}/>
                {errors.adminId && errors.adminId.type === 'required' && <span className='error'> Id is Required</span>}<br />
